...
//       filtered.sort((a, b) => {
//         const routeA = routesData.find((r) => r.id === a.route_id)
//         const routeB = routesData.find((r) => r.id === b.route_id)
//         return (routeA?.price || 0) - (routeB?.price || 0)
//       })
...
//     return (
//       routes.find((route) => route.id === shuttle.route_id) || {
//         origin: "Main Campus",
...
//                               {getFacilities(shuttle).map((facility: string, i: number) => (
